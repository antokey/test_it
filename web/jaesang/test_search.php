      ...
      <td>
        <ul>
          ...
          while($row2 = mysqli_fetch_array($result_sk)){
            echo "<li style='list-style:none;'>$row2[chulgo]</li>";
          }
          ?>
        </ul>
      </td>
      <td>
        <ul>
          ...
          while($row3 = mysqli_fetch_array($result_lg)){
            echo "<li style='list-style:none;'>$row3[chulgo]</li>";
          }
          ?>
        </ul>
      </td>
    ...
    <tr align = center>
      ...
      <td>
        <ul>
          ...
          if($category == 'phone_name'){
            ...
            while($row1 = mysqli_fetch_array($result_kt)){
              echo "<li style='list-style:none;'>$row1[gongshi]</li>";
            }
          }
          ?>
        </ul>
      ...
      <td>
        <ul>
          <?php
          while($row2 = mysqli_fetch_array($result_sk)){
            echo "<li style='list-style:none;'>$row2[gongshi]</li>";
          }
          ?>
        </ul>
      </td>
      <td>
        <ul>
          <?php
          while($row3 = mysqli_fetch_array($result_lg)){
            echo "<li style='list-style:none;'>$row3[gongshi]</li>";
          }
          ?>
        </ul>
      </td>
    ...
    <tr align = center>
      ...
      <td>
        <ul>
          ...
          if($category == 'phone_name'){
            ...
            while($row1 = mysqli_fetch_array($result_kt)){
              echo "<li style='list-style:none;'>$row1[chuga]</li>";
            }
          }
          ?>
        </ul>
      ...
      <td>
        <ul>
          <?php
          while($row2 = mysqli_fetch_array($result_sk)){
            echo "<li style='list-style:none;'>$row2[chuga]</li>";
          }
          ?>
        </ul>
      </td>
      <td>
        <ul>
          <?php
          while($row3 = mysqli_fetch_array($result_lg)){
            echo "<li style='list-style:none;'>$row3[chuga]</li>";
          }
          ?>
        </ul>
      </td>
    ...
    <tr align = center>
      ...
      <td>
        <ul>
          ...
          if($category == 'phone_name'){
            ...
            while($row1 = mysqli_fetch_array($result_kt)){
              echo "<li style='list-style:none;'>$row1[danmal]</li>";
            }
          }
          ?>
        </ul>
      ...
      <td>
        <ul>
          <?php
          while($row2 = mysqli_fetch_array($result_sk)){
            echo "<li style='list-style:none;'>$row2[danmal]</li>";
          }
          ?>
        </ul>
      </td>
      <td>
        <ul>
          <?php
          while($row3 = mysqli_fetch_array($result_lg)){
            echo "<li style='list-style:none;'>$row3[danmal]</li>";
          }
          ?>
        </ul>
      </td>
